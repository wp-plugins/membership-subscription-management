...
<li>
	...
	<div class="left width75"><?php echo stripslashes($this->item_description); ?></div>
	...
	<div style="position:relative;float:right;"> 
      <form action="<?php echo $action; ?>" method="post">
        ...
        <?php } ?>
        <input type="submit" name="submit" border="0" value="<?php echo $this->submit_button_text; ?>" alt="PayPal - The safer, easier way to pay online">
      </form>
    </div>
</li>
